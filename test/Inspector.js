...
//     await landRegistry.addLandInspector(account3.address,posdistrict2)
...
//       await landRegistry.connect(account1).verifyLandAccepted(2);
//     });
...
//       await expect(landRegistry.connect(account1).verifyLandAccepted(2)).to.be.reverted;
...
//         true
//       );
//       await expect(landRegistry.connect(user2).verifyUserAccepted(user4.address)).to.be
//         .reverted;
